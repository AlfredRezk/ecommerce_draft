...
import { z } from 'zod'
import { ProductSchema, UserSchema } from './validators'
...
export const products: z.infer<typeof ProductSchema>[] = [
  ...
  },
  {
    ...
    category: 'Jeans',
    brand: 'Wrangler',
    images: ['/images/products/p26-1.jpg', '/images/products/p26-2.jpg'],
    tags: ['best-seller', 'todays-deal'],
    isPublished: true,
    price: 81.78,
    listPrice: 149.99,
  ...
  // Watches
  {
    ...
    brand: 'Seiko',
    images: ['/images/products/p31-1.jpg', '/images/products/p31-2.jpg'],
    tags: ['new-arrival'],
    isPublished: true,
    price: 530.0,
    listPrice: 0,
  ...
  },
  {
    ...
    category: 'Wrist Watches',
    brand: 'Seiko',
    images: ['/images/products/p32-1.jpg', '/images/products/p32-2.jpg'],
    tags: ['featured'],
    isPublished: true,
    price: 375.83,
    listPrice: 400,
  ...
  },
  {
    ...
    category: 'Wrist Watches',
    brand: 'Casio',
    images: ['/images/products/p33-1.jpg', '/images/products/p33-2.jpg'],
    tags: ['best-seller'],
    isPublished: true,
    price: 60.78,
    listPrice: 0,
  ...
  },
  {
    ...
    category: 'Wrist Watches',
    brand: 'Casio',
    images: ['/images/products/p34-1.jpg', '/images/products/p34-2.jpg'],
    tags: ['todays-deal'],
    isPublished: true,
    price: 34.22,
    listPrice: 54.99,
  ...
  },
  {
    ...
    category: 'Wrist Watches',
    brand: 'Fossil',
    images: ['/images/products/p35-1.jpg', '/images/products/p35-2.jpg'],
    tags: ['new-arrival', 'featured'],
    isPublished: true,
    price: 171.22,
    listPrice: 225,
  ...
  },
  {
    ...
    category: 'Wrist Watches',
    brand: 'Fossil',
    images: ['/images/products/p36-1.jpg', '/images/products/p36-2.jpg'],
    tags: ['best-seller', 'todays-deal'],
    isPublished: true,
    price: 158.21,
    listPrice: 229.0,
  ...
  // Sneakers
  {
    ...
    category: 'Shoes',
    brand: 'adidas',
    images: ['/images/products/p41-1.jpg', '/images/products/p41-2.jpg'],
    tags: ['new-arrival'],
    isPublished: true,
    price: 81.99,
    listPrice: 0,
  ...
  },
  {
    ...
    category: 'Shoes',
    brand: 'ziitop',
    images: ['/images/products/p42-1.jpg', '/images/products/p42-2.jpg'],
    tags: ['featured'],
    isPublished: true,
    price: 39.97,
    listPrice: 49.96,
  ...
  },
  {
    ...
    category: 'Shoes',
    brand: 'Skechers',
    images: ['/images/products/p43-1.jpg', '/images/products/p43-2.jpg'],
    tags: ['best-seller'],
    isPublished: true,
    price: 99.99,
    listPrice: 0,
  ...
  },
  {
    ...
    category: 'Shoes',
    brand: 'DLWKIPV',
    images: ['/images/products/p44-1.jpg', '/images/products/p44-2.jpg'],
    tags: ['todays-deal'],
    isPublished: true,
    price: 36.99,
    listPrice: 56.9,
  ...
  },
  {
    ...
    category: 'Shoes',
    brand: 'ASICS',
    images: ['/images/products/p45-1.jpg', '/images/products/p45-2.jpg'],
    tags: ['new-arrival', 'featured'],
    isPublished: true,
    price: 179.95,
    listPrice: 200,
  ...
  },
  {
    ...
    category: 'Shoes',
    brand: 'Generic',
    images: ['/images/products/p46-1.jpg', '/images/products/p46-2.jpg'],
    tags: ['best-seller', 'todays-deal'],
    isPublished: true,
    price: 32.99,
    listPrice: 80,
